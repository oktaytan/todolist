...
// Remove ve complete buton svg ikonları
...
// Kullanıcı butona tıkladığında ekleme yapılacak
...
function addItemToDOM(text, completed) {
    ...
    //Remove butonuna tıklandığında listeden silme yapılacak
    ...
    //Complete butonuna tıklandığında görev tamamlanmışlar listesine geçecek
    complete.addEventListener('click', completeItem);

    buttons.appendChild(remove);
    buttons.appendChild(seperate);
